...
<main id="maincontent" role="main">
    <div class="middle-align container">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-gardening-landscaping'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php
            ...
            if($vw_gardening_landscaping_theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        <?php if( get_theme_mod( 'vw_gardening_landscaping_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'vw_gardening_landscaping_blog_post_pagination_position','bottom') == 'both') { ?>
                        ...
                        ?>
                        <?php if( get_theme_mod( 'vw_gardening_landscaping_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'vw_gardening_landscaping_blog_post_pagination_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'vw_gardening_landscaping_blog_pagination_hide_show',true) == 1) { ?>
                              <div class="navigation">
                                <?php vw_gardening_landscaping_blog_posts_pagination(); ?>
                                  <div class="clearfix"></div>
